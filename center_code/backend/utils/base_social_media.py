...
SOCIAL_MEDIA_WEIXIN = "weixin"  # 微信视频号


def get_supported_social_media() -> List[str]:
    return [SOCIAL_MEDIA_DOUYIN, SOCIAL_MEDIA_TENCENT, SOCIAL_MEDIA_TIKTOK, SOCIAL_MEDIA_KUAISHOU, SOCIAL_MEDIA_XIAOHONGSHU, SOCIAL_MEDIA_WEIXIN]
